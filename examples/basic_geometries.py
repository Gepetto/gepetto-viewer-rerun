...
def basic_geometries():
    ...
    rec.gui.addSquareFace(
        "square", (-4, 0, 1), (2, 6, 2), (3, 2, 3), (5, 4, 4), [25, 50, 130, 255]
    )
    rec.gui.addTriangleFace(
        "triangle", (5, 3, 1), (8, 6, -2), (5, 2, 3), [70, 30, 130, 255]
    )
...
if __name__ == "__main__":
    logging.basicConfig(
        filename="basic_geometries.log", filemode="w", level=logging.DEBUG
    )
    basic_geometries()
